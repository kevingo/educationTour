...
public class MyOAuth2 {
    ...
    public MyOAuth2(String authorizationURL,
    ...
    // First step of oauth 2.0 - redirect user to authorization page
	public void retrieveVerificationCode(String callbackURL) {
        throw new Redirect(authorizationURL
                + "?client_id=" + clientid
                + "&redirect_uri=" + callbackURL
                + "&scope=email,user_about_me,user_checkins,user_likes,publish_stream");
    }
